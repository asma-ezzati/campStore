...
const ContactUs = () => {
  return (
    <>
      <div className="min-h-screen bg-red m-2 p-4 rounded-md grid  lg:grid-cols-3 gap-2  grid-rows-1 gap-y-0 items-center  ">
        <div className="lg:border-l-2 border-peach">
          <img
            src={banner2}
        ...
        <div>
          ...
          <div className="grid grid-cols-5 grid-rows-1 items-center mr-7 sm:mr-16 pb-10">
